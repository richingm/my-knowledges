...
function useMask(options) {
	...
	const applyValue = (0, react.useCallback)(({ reprocessed, newRaw, displayValue, resolvedSlots, cursorPos, notifyChange }) => {
		const opts = optionsRef.current;
	...
	const initializeInputValue = (0, react.useCallback)((node) => {
		const opts = optionsRef.current;
