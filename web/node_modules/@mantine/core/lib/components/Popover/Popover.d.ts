...
import { PopoverContextMenu, PopoverContextMenuProps } from './PopoverContextMenu/PopoverContextMenu';
...
export declare namespace Popover {
    ...
    var ContextMenu: typeof PopoverContextMenu;
    ...
    var withProps: (fixedProps: Partial<PopoverProps>) => {
        (props: PopoverProps): import("react/jsx-runtime").JSX.Element;
        extend: (input: ExtendComponent<PopoverFactory>) => import("../../core/factory/factory").ExtendsRootComponent<{
            props: PopoverProps;
            stylesNames: PopoverStylesNames;
            vars: PopoverCssVariables;
        }>;
...
export declare namespace Popover {
    ...
    namespace ContextMenu {
        type Props = PopoverContextMenuProps;
    }
}
