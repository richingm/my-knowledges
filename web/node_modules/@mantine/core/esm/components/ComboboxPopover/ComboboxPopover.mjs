...
import Combobox_module_default from "../Combobox/Combobox.module.mjs";
...
import { defaultOptionsFilter } from "../Combobox/OptionsDropdown/default-options-filter.mjs";
import { isEmptyComboboxData } from "../Combobox/OptionsDropdown/is-empty-combobox-data.mjs";
import { OptionsDropdown } from "../Combobox/OptionsDropdown/OptionsDropdown.mjs";
import { ComboboxPopoverTarget } from "./ComboboxPopoverTarget.mjs";
...
function SearchableDropdown({ data, filter, search, limit, nothingFoundMessage, withScrollArea = true, maxDropdownHeight, value, checkIconPosition, withCheckIcon = false, withAlignedLabels = false, unstyled, renderOption, scrollAreaProps, onSearchChange }) {
	...
	const options = filteredData.map((item, index) => /* @__PURE__ */ jsx(Option, {
		data: item,
		withCheckIcon,
		withAlignedLabels,
		value,
		...
		unstyled,
		renderOption
	}, isOptionsGroup(item) ? `group-${typeof item.group === "string" ? item.group : index}` : `${item.value}`));
	return /* @__PURE__ */ jsxs(Combobox.Dropdown, {
		"data-composed": true,
		children: [/* @__PURE__ */ jsx(Combobox.Search, {
			value: search,
			onChange: onSearchChange,
			placeholder: "Search..."
		}), /* @__PURE__ */ jsxs(Combobox.Options, { children: [withScrollArea ? /* @__PURE__ */ jsx(ScrollArea.Autosize, {
...
const ComboboxPopover = genericFactory((_props) => {
	...
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsxs(Combobox, {
		...
		...comboboxProps,
		...others,
		children: [children, searchable ? /* @__PURE__ */ jsx(SearchableDropdown, {
			data: parsedData,
			filter,
			search: _searchValue,
			limit,
...
//# sourceMappingURL=ComboboxPopover.mjs.map