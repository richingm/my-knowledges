 ...
 */
export declare const Thread: ({ thread, selected, orphaned, referenceText, maxCommentsBeforeCollapse, onFocus, onBlur, tabIndex, }: ThreadProps) => import("react/jsx-runtime").JSX.Element;
