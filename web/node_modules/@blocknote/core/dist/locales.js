import { t as e } from "./en-B9hMApn4.js";
//#region src/i18n/locales/ar.ts
var t = {
	slash_menu: {
		heading: {
			title: "عنوان 1",
	...
	toggle_blocks: { add_block_button: "تبديل فارغ. انقر لإضافة كتلة." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "لم يتم العثور على عناصر" },
	color_picker: {
		text_title: "نص",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "تبديل المعاينة" },
		nest: {
		...
		align_left: { tooltip: "محاذاة النص إلى اليسار" },
		align_center: { tooltip: "محاذاة النص في المنتصف" },
		align_right: { tooltip: "محاذاة النص إلى اليمين" },
		align_justify: { tooltip: "ضبط النص" },
		table_cell_merge: { tooltip: "جمع الخلايا" },
		comment: { tooltip: "إضافة ملاحظة" }
	},
	file_panel: {
		upload: {
			title: "تحميل",
	...
	link_toolbar: {
		delete: { tooltip: "إزالة الرابط" },
		edit: {
			text: "تحرير الرابط",
			tooltip: "تحرير"
		},
		open: { tooltip: "فتح في تبويب جديد" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "تفاعل بواسطة" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Leerer aufklappbarer Bereich. Klicken, um einen Block hinzuzufügen." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Keine Elemente gefunden" },
	color_picker: {
		text_title: "Text",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Vorschau umschalten" },
		nest: {
		...
		align_left: { tooltip: "Text linksbündig" },
		align_center: { tooltip: "Text zentrieren" },
		align_right: { tooltip: "Text rechtsbündig" },
		align_justify: { tooltip: "Text Blocksatz" },
		table_cell_merge: { tooltip: "Zellen zusammenführen" },
		comment: { tooltip: "Kommentar hinzufügen" }
	},
	file_panel: {
		upload: {
			title: "Hochladen",
	...
	link_toolbar: {
		delete: { tooltip: "Link entfernen" },
		edit: {
			text: "Link bearbeiten",
			tooltip: "Bearbeiten"
		},
		open: { tooltip: "In neuem Tab öffnen" },
		form: {
	...
	toggle_blocks: { add_block_button: "Toggle vacío. Haz clic para añadir un bloque." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "No se encontraron elementos" },
	color_picker: {
		text_title: "Texto",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Alternar vista previa" },
		nest: {
		...
		align_left: { tooltip: "Alinear texto a la izquierda" },
		align_center: { tooltip: "Alinear texto al centro" },
		align_right: { tooltip: "Alinear texto a la derecha" },
		align_justify: { tooltip: "Justificar texto" },
		table_cell_merge: { tooltip: "Combinar celdas" },
		comment: { tooltip: "Añadir comentario" }
	},
	file_panel: {
		upload: {
			title: "Subir",
	...
	link_toolbar: {
		delete: { tooltip: "Eliminar enlace" },
		edit: {
			text: "Editar enlace",
			tooltip: "Editar"
		},
		open: { tooltip: "Abrir en nueva pestaña" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Reaccionado por" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "تاشوی خالی. برای افزودن بلوک کلیک کنید." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "موردی یافت نشد" },
	color_picker: {
		text_title: "متن",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "تغییر وضعیت پیش‌نمایش" },
		nest: {
		...
		align_left: { tooltip: "تراز متن چپ" },
		align_center: { tooltip: "تراز متن وسط" },
		align_right: { tooltip: "تراز متن راست" },
		align_justify: { tooltip: "تراز متن دوطرفه" },
		table_cell_merge: { tooltip: "ادغام سلول‌ها" },
		comment: { tooltip: "افزودن دیدگاه" }
	},
	file_panel: {
		upload: {
			title: "بارگزاری",
	...
	link_toolbar: {
		delete: { tooltip: "حذف لینک" },
		edit: {
			text: "ویرایش لینک",
			tooltip: "ویرایش"
		},
		open: { tooltip: "باز کردن در تب جدید" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "واکنش داده شده توسط" },
		sidebar: {
			marked_as_resolved: "به عنوان حل شده علامت‌گذاری شد",
			more_replies: (e) => `${e} پاسخ دیگر`
		}
	},
	generic: { ctrl_shortcut: "Ctrl" }
}, a = {
	...
	toggle_blocks: { add_block_button: "Liste repliable vide. Cliquez pour ajouter un bloc." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Aucun élément trouvé" },
	color_picker: {
		text_title: "Texte",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Basculer l'aperçu" },
		nest: {
		...
		align_left: { tooltip: "Aligner le texte à gauche" },
		align_center: { tooltip: "Aligner le texte au centre" },
		align_right: { tooltip: "Aligner le texte à droite" },
		align_justify: { tooltip: "Justifier le texte" },
		table_cell_merge: { tooltip: "Fusionner les cellules" },
		comment: { tooltip: "Ajouter un commentaire" }
	},
	file_panel: {
		upload: {
			title: "Télécharger",
	...
	link_toolbar: {
		delete: { tooltip: "Supprimer le lien" },
		edit: {
			text: "Modifier le lien",
			tooltip: "Modifier"
		},
		open: { tooltip: "Ouvrir dans un nouvel onglet" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Réagi par" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "מתג ריק. לחץ כדי להוסיף בלוק." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "לא נמצאו פריטים" },
	color_picker: {
		text_title: "טקסט",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "החלף תצוגה מקדימה" },
		nest: {
			tooltip: "קינון בלוק",
			secondary_tooltip: "Tab"
		},
		...
		align_left: { tooltip: "ישר טקסט לשמאל" },
		align_center: { tooltip: "מרכז טקסט" },
		align_right: { tooltip: "ישר טקסט לימין" },
		align_justify: { tooltip: "ישר טקסט לשני הצדדים" },
		table_cell_merge: { tooltip: "מיזוג תאים" },
		comment: { tooltip: "הוסף תגובה" }
	},
	file_panel: {
		upload: {
			title: "העלאה",
	...
	link_toolbar: {
		delete: { tooltip: "הסר קישור" },
		edit: {
			text: "ערוך קישור",
			tooltip: "ערוך"
		},
		open: { tooltip: "פתח בכרטיסייה חדשה" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "קיבל תגובה מ" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Prazan sklopivi blok. Klikni da dodaš sadržaj." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Stavke nisu pronađene" },
	color_picker: {
		text_title: "Tekst",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Prikaži/sakrij pregled" },
		nest: {
		...
		align_left: { tooltip: "Poravnaj tekst lijevo" },
		align_center: { tooltip: "Poravnaj tekst po sredini" },
		align_right: { tooltip: "Poravnaj tekst desno" },
		align_justify: { tooltip: "Poravnaj tekst obostrano" },
		table_cell_merge: { tooltip: "Spoji ćelije" },
		comment: { tooltip: "Dodaj komentar" }
	},
	file_panel: {
		upload: {
			title: "Učitaj",
	...
	link_toolbar: {
		delete: { tooltip: "Ukloni poveznicu" },
		edit: {
			text: "Uredi poveznicu",
			tooltip: "Uredi"
		},
		open: { tooltip: "Otvori u novoj kartici" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Reagirao/la" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Tóm fellilína. Smelltu til að bæta við blokk." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Engir hlutir fundust" },
	color_picker: {
		text_title: "Texti",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Skipta um forskoðun" },
		nest: {
		...
		align_left: { tooltip: "Vinstrijafna texta" },
		align_center: { tooltip: "Miðjustilla texta" },
		align_right: { tooltip: "Hægrijafna texta" },
		align_justify: { tooltip: "Jafna texta" },
		table_cell_merge: { tooltip: "Sameina dálka" },
		comment: { tooltip: "Bæta við athugasemd" }
	},
	file_panel: {
		upload: {
			title: "Hlaða upp",
	...
	link_toolbar: {
		delete: { tooltip: "Fjarlægja tengil" },
		edit: {
			text: "Breyta tengli",
			tooltip: "Breyta"
		},
		open: { tooltip: "Opna í nýjum flipa" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Brást við af" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Toggle vuoto. Clicca per aggiungere un blocco." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Nessun elemento trovato" },
	color_picker: {
		text_title: "Testo",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Attiva/disattiva anteprima" },
		nest: {
		...
		align_left: { tooltip: "Allinea testo a sinistra" },
		align_center: { tooltip: "Allinea testo al centro" },
		align_right: { tooltip: "Allinea testo a destra" },
		align_justify: { tooltip: "Giustifica testo" },
		table_cell_merge: { tooltip: "Unisci celle" },
		comment: { tooltip: "Aggiungi commento" }
	},
	file_panel: {
		upload: {
			title: "Carica",
	...
	link_toolbar: {
		delete: { tooltip: "Rimuovi link" },
		edit: {
			text: "Modifica link",
			tooltip: "Modifica"
		},
		open: { tooltip: "Apri in una nuova scheda" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Reagito da" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "空のトグルです。クリックしてブロックを追加。" },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "アイテムが見つかりません" },
	color_picker: {
		text_title: "文字色",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "プレビューの切り替え" },
		nest: {
			tooltip: "インデント増",
			secondary_tooltip: "Tab"
		},
		...
		align_left: { tooltip: "左揃え" },
		align_center: { tooltip: "中央揃え" },
		align_right: { tooltip: "右揃え" },
		align_justify: { tooltip: "両端揃え" },
		table_cell_merge: { tooltip: "セルを結合" },
		comment: { tooltip: "コメントを追加" }
	},
	file_panel: {
		upload: {
			title: "アップロード",
	...
	link_toolbar: {
		delete: { tooltip: "リンクを解除" },
		edit: {
			text: "リンクを編集",
			tooltip: "編集"
		},
		open: { tooltip: "新しいタブでリンクを開く" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "リアクションした人" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "비어 있는 토글입니다. 클릭하여 블록을 추가하세요." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "항목을 찾을 수 없음" },
	color_picker: {
		text_title: "텍스트",
		background_title: "배경",
		colors: {
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "미리보기 전환" },
		nest: {
			tooltip: "중첩 블록",
			secondary_tooltip: "Tab"
		},
		...
		align_left: { tooltip: "텍스트 왼쪽 맞춤" },
		align_center: { tooltip: "텍스트 가운데 맞춤" },
		align_right: { tooltip: "텍스트 오른쪽 맞춤" },
		align_justify: { tooltip: "텍스트 양쪽 맞춤" },
		table_cell_merge: { tooltip: "셀 병합" },
		comment: { tooltip: "코멘트 추가" }
	},
	file_panel: {
		upload: {
			title: "업로드",
	...
	link_toolbar: {
		delete: { tooltip: "링크 삭제" },
		edit: {
			text: "링크 수정",
			tooltip: "수정"
		},
		open: { tooltip: "새 탭으로 열기" },
		form: {
	...
	toggle_blocks: { add_block_button: "Lege uitklapper. Klik om een blok toe te voegen." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Geen items gevonden" },
	color_picker: {
		text_title: "Tekst",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Voorbeeldschakelaar" },
		nest: {
			tooltip: "Nest blok",
			secondary_tooltip: "Tab"
		},
		...
		align_left: { tooltip: "Tekst links uitlijnen" },
		align_center: { tooltip: "Tekst centreren" },
		align_right: { tooltip: "Tekst rechts uitlijnen" },
		align_justify: { tooltip: "Tekst uitvullen" },
		table_cell_merge: { tooltip: "Voeg cellen samen" },
		comment: { tooltip: "Commentaar toevoegen" }
	},
	file_panel: {
		upload: {
			title: "Upload",
	...
	link_toolbar: {
		delete: { tooltip: "Verwijder link" },
		edit: {
			text: "Bewerk link",
			tooltip: "Bewerk"
		},
		open: { tooltip: "Open in nieuw tabblad" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Gereageerd door" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Tomt toggle. Klikk for å legge til en blokk." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Ingen elementer funnet" },
	color_picker: {
		text_title: "Tekst",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Veksle forhåndsvisning" },
		nest: {
		...
		align_left: { tooltip: "Venstrejuster tekst" },
		align_center: { tooltip: "Midtstill tekst" },
		align_right: { tooltip: "Høyrejuster tekst" },
		align_justify: { tooltip: "Juster tekst" },
		comment: { tooltip: "Legg til kommentar" },
		table_cell_merge: { tooltip: "Slå sammen celler" }
	},
	file_panel: {
		upload: {
			title: "Last opp",
	...
	link_toolbar: {
		delete: { tooltip: "Fjern lenke" },
		edit: {
			text: "Rediger lenke",
			tooltip: "Rediger"
		},
		open: { tooltip: "Åpne i ny fane" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Reagert av" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Brak bloków do rozwinięcia. Kliknij, aby dodać pierwszego." },
	side_menu: {
		add_block_label: "Dodaj blok",
	...
	suggestion_menu: { no_items_title: "Nie znaleziono elementów" },
	color_picker: {
		text_title: "Tekst",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Przełącz podgląd" },
		nest: {
		...
		align_left: { tooltip: "Wyrównaj tekst do lewej" },
		align_center: { tooltip: "Wyśrodkuj tekst" },
		align_right: { tooltip: "Wyrównaj tekst do prawej" },
		align_justify: { tooltip: "Wyjustuj tekst" },
		table_cell_merge: { tooltip: "Połącz komórki" },
		comment: { tooltip: "Dodaj komentarz" }
	},
	file_panel: {
		upload: {
			title: "Wrzuć",
	...
	link_toolbar: {
		delete: { tooltip: "Usuń link" },
		edit: {
			text: "Edytuj link",
			tooltip: "Edytuj"
		},
		open: { tooltip: "Otwórz w nowej karcie" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Zareagowali" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Toggle vazio. Clique para adicionar um bloco." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Nenhum item encontrado" },
	color_picker: {
		text_title: "Texto",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Alternar visualização" },
		nest: {
		...
		align_left: { tooltip: "Alinhar à esquerda" },
		align_center: { tooltip: "Alinhar ao centro" },
		align_right: { tooltip: "Alinhar à direita" },
		align_justify: { tooltip: "Justificar texto" },
		table_cell_merge: { tooltip: "Juntar células" },
		comment: { tooltip: "Adicionar comentário" }
	},
	file_panel: {
		upload: {
			title: "Upload",
	...
	link_toolbar: {
		delete: { tooltip: "Remover link" },
		edit: {
			text: "Editar link",
			tooltip: "Editar"
		},
		open: { tooltip: "Abrir em nova aba" },
		form: {
			title_placeholder: "Editar título",
			url_placeholder: "Editar URL"
		}
	...
	comments: {
		...
		reactions: { reacted_by: "Reagido por" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Пустой переключатель. Нажмите, чтобы добавить блок." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "ничего не найдено" },
	color_picker: {
		text_title: "Текст",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Переключить предварительный просмотр" },
		nest: {
		...
		align_left: { tooltip: "Текст по левому краю" },
		align_center: { tooltip: "Текст по середине" },
		align_right: { tooltip: "Текст по правому краю" },
		align_justify: { tooltip: "По середине текст" },
		table_cell_merge: { tooltip: "Объединить ячейки" },
		comment: { tooltip: "Добавить комментарий" }
	},
	file_panel: {
		upload: {
			title: "Загрузить",
	...
	link_toolbar: {
		delete: { tooltip: "Удалить ссылку" },
		edit: {
			text: "Изменить ссылку",
			tooltip: "Редактировать"
		},
		open: { tooltip: "Открыть в новой вкладке" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Отреагировал(а)" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Prázdne prepínanie. Kliknite pre pridanie bloku." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Nenašli sa žiadne položky" },
	color_picker: {
		text_title: "Text",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Prepnúť náhľad" },
		nest: {
		...
		align_left: { tooltip: "Zarovnať text vľavo" },
		align_center: { tooltip: "Zarovnať text na stred" },
		align_right: { tooltip: "Zarovnať text vpravo" },
		align_justify: { tooltip: "Zarovnať text do bloku" },
		table_cell_merge: { tooltip: "Zlúčiť bunky" },
		comment: { tooltip: "Pridať komentár" }
	},
	file_panel: {
		upload: {
			title: "Nahratie",
	...
	link_toolbar: {
		delete: { tooltip: "Odstrániť odkaz" },
		edit: {
			text: "Upraviť odkaz",
			tooltip: "Upraviť"
		},
		open: { tooltip: "Otvoriť v novom okne" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Reagoval/a" },
		sidebar: {
			marked_as_resolved: "Označené ako vyriešené",
			more_replies: (e) => `${e} ďalších odpovedí`
		}
	},
	generic: { ctrl_shortcut: "Ctrl" }
}, v = {
	...
	toggle_blocks: { add_block_button: "Порожній перемикач. Натисніть, щоб додати блок." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Нічого не знайдено" },
	color_picker: {
		text_title: "Текст",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Перемкнути попередній перегляд" },
		nest: {
		...
		align_left: { tooltip: "Вирівняти за лівим краєм" },
		align_center: { tooltip: "Вирівняти по центру" },
		align_right: { tooltip: "Вирівняти за правим краєм" },
		align_justify: { tooltip: "Вирівняти за шириною" },
		table_cell_merge: { tooltip: "Об'єднати клітинки" },
		comment: { tooltip: "Додати коментар" }
	},
	file_panel: {
		upload: {
			title: "Завантажити",
	...
	link_toolbar: {
		delete: { tooltip: "Видалити посилання" },
		edit: {
			text: "Редагувати посилання",
			tooltip: "Редагувати"
		},
		open: { tooltip: "Відкрити в новій вкладці" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Відреагував(ла)" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "Toggle trống. Nhấp để thêm khối." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "Không tìm thấy mục nào" },
	color_picker: {
		text_title: "Văn bản",
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "Chuyển đổi xem trước" },
		nest: {
			tooltip: "Lồng khối",
			secondary_tooltip: "Tab"
		},
		...
		align_left: { tooltip: "Căn trái văn bản" },
		align_center: { tooltip: "Căn giữa văn bản" },
		align_right: { tooltip: "Căn phải văn bản" },
		align_justify: { tooltip: "Căn đều văn bản" },
		table_cell_merge: { tooltip: "Gộp các ô" },
		comment: { tooltip: "Thêm bình luận" }
	},
	file_panel: {
		upload: {
			title: "Tải lên",
	...
	link_toolbar: {
		delete: { tooltip: "Xóa liên kết" },
		edit: {
			text: "Chỉnh sửa liên kết",
			tooltip: "Chỉnh sửa"
		},
		open: { tooltip: "Mở trong tab mới" },
		form: {
	...
	comments: {
		...
		reactions: { reacted_by: "Phản ứng bởi" },
		sidebar: {
	...
	toggle_blocks: { add_block_button: "空的切换区。点击添加区块。" },
	side_menu: {
		add_block_label: "添加块",
	...
	suggestion_menu: { no_items_title: "无匹配项" },
	color_picker: {
		text_title: "文本",
		background_title: "背景色",
		colors: {
	...
	formatting_toolbar: {
		...
		align_center: { tooltip: "居中" },
		align_right: { tooltip: "右对齐" },
		align_justify: { tooltip: "文本对齐" },
	...
	toggle_blocks: { add_block_button: "空的切換區。點擊新增區塊。" },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "無相符項目" },
	color_picker: {
		text_title: "文字",
		background_title: "背景色",
		colors: {
	...
	formatting_toolbar: {
		...
		file_preview_toggle: { tooltip: "切換預覽" },
		nest: {
			tooltip: "巢狀",
			secondary_tooltip: "Tab"
		},
	...
	comments: {
		...
		reactions: { reacted_by: "已回應" },
		sidebar: {
			marked_as_resolved: "標記為已解決",
			more_replies: (e) => `還有 ${e} 則回覆`
		}
	},
	generic: { ctrl_shortcut: "Ctrl" }
}, S = {
	...
	toggle_blocks: { add_block_button: "Bo‘sh toggle. Blok qo‘shish uchun bosing." },
	side_menu: {
	...
	suggestion_menu: { no_items_title: "hech narsa topilmadi" },
	color_picker: {
		text_title: "Matn",
	...
	formatting_toolbar: {
		...
		underline: {
			tooltip: "Tagi chizilgan",
			secondary_tooltip: "Mod+U"
		},
		strike: {
			tooltip: "Usti chizilgan",
			secondary_tooltip: "Mod+Shift+X"
		},
		code: {
			tooltip: "Kod",
		...
		file_preview_toggle: { tooltip: "Oldindan ko‘rishni almashtirish" },
		nest: {
			tooltip: "O‘ngga surish",
			secondary_tooltip: "Tab"
		},
		unnest: {
			tooltip: "Chapga surish",
			secondary_tooltip: "Shift+Tab"
		},
	...
	comments: {
		...
		reactions: { reacted_by: "Reaksiya bildirgan" },
		sidebar: {
			marked_as_resolved: "Hal qilingan deb belgilandi",
			more_replies: (e) => `${e} ta qo‘shimcha javob`
		}
	},
	generic: { ctrl_shortcut: "Ctrl" }
};
//#endregion
export { t as ar, n as de, e as en, r as es, i as fa, a as fr, o as he, s as hr, c as is, l as it, u as ja, d as ko, f as nl, p as no, m as pl, h as pt, g as ru, _ as sk, v as uk, S as uz, y as vi, b as zh, x as zhTW };
