...
import { t as require_react_dom } from "./react-dom-CjkJE_Yh.js";
import { C as s$1, Fr as ySyncPluginKey, Gr as DecorationSet, Hr as mergeAttributes, Ir as Mark, Kr as Plugin, Pn as ei, Pr as getRelativeSelection, S as e$2, Ur as posToDOMRect, Wr as Decoration, Xr as r$1, Yr as n$1, fn as Xr, l as Mi, qr as PluginKey, tr as mr } from "./blocknote-Bz5zP0gl.js";
...
var index$1 = typeof document !== "undefined" ? import_react$1.useLayoutEffect : function noop() {};
var SafeReact$1 = { ...import_react$1 };
...
var require_react_jsx_runtime_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		var React = require_react$1(), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_ACTIVITY_TYPE = Symbol.for("react.activity"), REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, hasOwnProperty = Object.prototype.hasOwnProperty, isArrayImpl = Array.isArray, createTask = console.createTask ? console.createTask : function() {
			return null;
		};
...
function useMergeRefs(refs) {
	const cleanupRef = import_react$1.useRef(void 0);
	const refEffect = import_react$1.useCallback((instance) => {
...
var FloatingNodeContext = /* @__PURE__ */ import_react$1.createContext(null);
var FloatingTreeContext = /* @__PURE__ */ import_react$1.createContext(null);
/**
...
*/
var useFloatingTree = () => import_react$1.useContext(FloatingTreeContext);
...
var NOOP = () => {};
var FloatingDelayGroupContext = /* @__PURE__ */ import_react$1.createContext({
	delay: 0,
	initialDelay: 0,
	timeoutMs: 0,
	currentId: null,
...
*/
var useDelayGroupContext = () => import_react$1.useContext(FloatingDelayGroupContext);
/**
...
var FocusGuard = /* @__PURE__ */ import_react$1.forwardRef(function FocusGuard(props, ref) {
...
var PortalContext = /* @__PURE__ */ import_react$1.createContext(null);
...
var usePortalContext = () => import_react$1.useContext(PortalContext);
...
var VisuallyHiddenDismiss = /* @__PURE__ */ import_react$1.forwardRef(function VisuallyHiddenDismiss(props, ref) {
...
function FloatingFocusManager(props) {
	...
	const blurTimeoutRef = import_react$1.useRef(-1);
...
function useFloatingRootContext(options) {
	...
	const [events] = import_react$1.useState(() => createEventEmitter());
...
function useRole(context, props) {
	...
	const floatingId = import_react$1.useMemo(() => {
...
var require_with_selector_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
		var React = require_react$1(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef = React.useRef, useEffect = React.useEffect, useMemo = React.useMemo, useDebugValue = React.useDebugValue;
...
//#endregion
//#region node_modules/@blocknote/react/dist/defaultCommentEditorSchema-3DnX6Knw.js
...
var A = (0, import_react$1.createContext)(void 0);
function j(e) {
	return (0, import_react$1.useContext)(A);
}
function M(e) {
	let t = j(e);
...
var L = (e) => {
	...
	let { whileElementsMounted: r, ...a } = e.useFloatingOptions ?? {}, { refs: o, floatingStyles: c, context: y } = useFloating({
		whileElementsMounted: I(autoUpdate, e.useFloatingOptions?.whileElementsMounted),
		...a
	}), { isMounted: b, styles: x } = useTransitionStyles(y, e.useTransitionStylesProps), { status: S } = useTransitionStatus(y, e.useTransitionStatusProps), { getFloatingProps: C } = useInteractions([useDismiss(y, e.useDismissProps), useHover(y, {
		enabled: !1,
		...e.useHoverProps
	})]), w = (0, import_react$1.useRef)(""), E = (0, import_react$1.useRef)(null), D = useMergeRefs([E, o.setFloating]);
	if ((0, import_react$1.useEffect)(() => {
		if (e.reference) {
	...
	return S === "close" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingPortal, {
		root: n,
	...
	}) : e.focusManagerProps?.disabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingPortal, {
		root: n,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			ref: D,
			...O,
	...
	}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingPortal, {
		root: n,
...
}, R = (0, import_react$1.createContext)(void 0);
function z() {
	return (0, import_react$1.useContext)(R);
}
function B() {
	return j().editor.dictionary;
}
var V = typeof window < "u" ? import_react$1.useLayoutEffect : import_react$1.useEffect, H = class {
	transactionNumber = 0;
...
function U(e) {
	let t = j(), n = e.editor || t?.editor || null, i = e.on || "all", [a] = (0, import_react$1.useState)(() => new H(n)), o = (0, import_with_selector.useSyncExternalStoreWithSelector)(a.subscribe, a.getSnapshot, a.getServerSnapshot, e.selector, e.equalityFn ?? import_react.default);
	return V(() => a.watch(n, i), [
		n,
		a,
		i
	]), (0, import_react$1.useDebugValue)(o), o;
}
function W(e) {
	let t = j();
	return e ||= t?.editor, U({
...
var G = (e) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(L, {
		reference: (0, import_react$1.useMemo)(() => {
			if (!(a === void 0 || s === void 0)) return {
				element: l?.firstElementChild || void 0,
				getBoundingClientRect: () => posToDOMRect(c.prosemirrorView, a, s ?? a)
			};
		}, [
			c,
			l,
...
}, K = (e = {}, t = []) => (0, import_react$1.useMemo)(() => {
	let t = Mi.create(e);
	return window && (window.ProseMirror = t._tiptapEditor), t;
}, t), q = (e) => {
	let [n, r] = (0, import_react$1.useState)(!1), a = U({
		editor: e.editor,
		selector: ({ editor: e }) => e.isEmpty
	}), o = z(), s = (0, import_react$1.useCallback)(() => {
		r(!0);
	}, []), l = (0, import_react$1.useCallback)(() => {
		r(!1);
	}, []);
	return (0, import_react$1.useEffect)(() => {
		e.editable && e.autoFocus && e.editor.focus();
	}, [
		e.autoFocus,
		e.editable,
		e.editor
	]), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(o.Comments.Editor, {
		...
		onBlur: l,
		editable: e.editable
	}), e.actions && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
}, { textColor: J, backgroundColor: Y, ...X } = Xr, Z = ei.create({
	blockSpecs: { paragraph: mr() },
	styleSpecs: X
});
//#endregion
//#region node_modules/@blocknote/react/dist/rolldown-runtime-CAFD8bLK.js
...
//#endregion
//#region node_modules/@blocknote/core/dist/comments.js
var m = Mark.create({
	name: "comment",
	excludes: "",
	inclusive: !1,
	...
	renderHTML({ HTMLAttributes: e }) {
		return ["span", mergeAttributes(e, { class: "bn-thread-mark" })];
	},
	parseHTML() {
...
}, g = new PluginKey("blocknote-comments");
function _(e, t) {
...
var v = n$1(({ editor: t, options: { schema: r, threadStore: i, resolveUsers: a } }) => {
	if (!a) throw Error("resolveUsers is required to be defined when using comments");
	if (!i) throw Error("threadStore is required to be defined when using comments");
	let s = m.name, c = new h(a), p = r$1({
		pendingComment: !1,
		selectedThreadId: void 0,
		threadPositions: /* @__PURE__ */ new Map()
	}, { onUpdate() {
		p.state.selectedThreadId !== p.prevState.selectedThreadId && t.transact((e) => e.setMeta(g, !0));
	} }), v = (e) => {
		t.transact((t) => {
			t.doc.descendants((n, r) => {
				n.marks.forEach((i) => {
					if (i.type.name === s) {
						let a = i.type, o = i.attrs.threadId, s = e.get(o), c = !!(!s || s.resolved || s.deletedAt);
						if (c !== i.attrs.orphan) {
							let e = Math.max(r, 0), s = Math.min(r + n.nodeSize, t.doc.content.size - 1, t.doc.content.size - 1);
							t.removeMark(e, s, i), t.addMark(e, s, a.create({
								...i.attrs,
								orphan: c
							})), c && p.state.selectedThreadId === o && p.setState((e) => ({
								...e,
								selectedThreadId: void 0
							}));
						}
	...
	return {
		...
		prosemirrorPlugins: [new Plugin({
			...
			state: {
				...
				apply(e, t) {
					...
					let r = e.docChanged ? _(e.doc, s) : p.state.threadPositions;
					(r.size > 0 || p.state.threadPositions.size > 0) && p.setState((e) => ({
						...e,
						threadPositions: r
					}));
					let i = [];
					if (p.state.selectedThreadId) {
						let e = r.get(p.state.selectedThreadId);
						e && i.push(Decoration.inline(e.from, e.to, { class: "bn-thread-mark-selected" }));
					}
					return { decorations: DecorationSet.create(e.doc, i) };
				}
			},
			props: {
				decorations(e) {
					return g.getState(e)?.decorations ?? DecorationSet.empty;
				},
				handleClick: (e, t, n) => {
					if (n.button !== 0) return !1;
					let r = e.state.doc.nodeAt(t);
					if (!r) return p.setState((e) => ({
						...e,
						selectedThreadId: void 0
					})), !1;
					let i = r.marks.find((e) => e.type.name === s && e.attrs.orphan !== !0);
					if (!i) return p.state.selectedThreadId !== void 0 && p.setState((e) => ({
						...e,
						selectedThreadId: void 0
					})), !1;
					let a = i.attrs.threadId;
					return a === p.state.selectedThreadId ? !1 : (p.setState((e) => ({
						...e,
						selectedThreadId: a
					})), !0);
				}
		...
		mount() {
			let e = i.subscribe(v);
			v(i.getThreads());
			let n = t.onSelectionChange(() => {
				p.state.pendingComment && p.setState((e) => ({
					...e,
					pendingComment: !1
				}));
			});
		...
		selectThread(e, n = !0) {
			if (p.state.selectedThreadId !== e && (p.setState((t) => ({
				...t,
				pendingComment: !1,
				selectedThreadId: e
			})), e && n)) {
				let n = p.state.threadPositions.get(e);
				if (!n) return;
				(t.prosemirrorView?.domAtPos(n.from).node)?.scrollIntoView({
					behavior: "smooth",
					block: "center"
				});
			}
		...
		startPendingComment() {
			p.setState((e) => ({
				...
				selectedThreadId: void 0,
				pendingComment: !0
			})), t.domElement?.focus(), t.getExtension(s$1)?.showSelection(!0, "comments");
		},
		stopPendingComment() {
			p.setState((e) => ({
				...e,
				selectedThreadId: void 0,
				pendingComment: !1
			})), t.getExtension(s$1)?.showSelection(!1, "comments");
		},
		async createThread(e) {
			let n = await i.createThread(e);
			if (i.addThreadToDocument) {
				let e = t.prosemirrorView, r = e.state.selection, a = ySyncPluginKey.getState(e.state), o = {
					prosemirror: {
						head: r.head,
						anchor: r.anchor
					},
					yjs: a ? getRelativeSelection(a.binding, e.state) : void 0
				};
				await i.addThreadToDocument({
					threadId: n.id,
					selection: o
				});
			} else t._tiptapEditor.commands.setMark(s, {
				orphan: !1,
				threadId: n.id
			});
		},
		userStore: c,
		commentEditorSchema: r
	};
});
//#endregion
export { useTransitionStyles as A, autoUpdate as B, useDelayGroup as C, useHover as D, useFocus as E, inline as F, getOverflowAncestors as H, limitShift as I, offset as L, autoPlacement as M, flip as N, useInteractions as O, hide as P, shift as R, safePolygon as S, useFloating as T, require_jsx_runtime as V, q as _, F as a, require_shim as b, L as c, P as d, R as f, j as g, Z as h, B as i, arrow as j, useRole as k, M as l, W as m, t as n, G as o, U as p, A as r, K as s, v as t, N as u, z as v, useDismiss as w, FloatingDelayGroup as x, require_with_selector as y, size as z };

//# sourceMappingURL=comments-DRyPXdwJ.js.map